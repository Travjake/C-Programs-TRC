...
namespace Skeleton_Program
{
    ...
    {
        public SmallSettlement(int newsizex, int newsizey, int newhouseholdnumber)
            : base()
        {
            xSize = newsizex;
            ySize = newsizey;
            startNoOfHouseholds = newhouseholdnumber;
            for (int count = 1; count < newhouseholdnumber + 1; count++)
            {
                AddHousehold();
            }
        }
    ...
    class Company
    {
        ...
        public string ProcessDayEnd()
        {
            ...
            details += "\nToday's Profits Were: " + (profitLossFromOutlets - dailyCosts - deliveryCosts);
    ...
    class Simulation
    {
        ...
        public Simulation()
        {
            ...
            string choice;
            Console.Write("Enter L for a large settlement, S for a small settlement or anything else for a normal size settlement: ");
            ...
            if (choice == "S")
            {
                int newsizex, newsizey, newhouseholdnumber;
                Console.Write("Enter width of the X axis: ");
                newsizex = Convert.ToInt32(Console.ReadLine());
                Console.Write("Enter Width of the Y axis: ");
                newsizey = Convert.ToInt32(Console.ReadLine());
                Console.Write("Enter number of households: ");
                newhouseholdnumber = Convert.ToInt32(Console.ReadLine());
                simulationSettlement = new SmallSettlement(newsizex, newsizey, newhouseholdnumber);
            }
            else
            {
        ...
        public void DisplayMenu()
        {
            ...
            Console.WriteLine("\n*********************************");
            Console.WriteLine("******    MENU || DAY " + Day + "    ******");
            Console.WriteLine("*********************************");
        ...
        private void ProcessFoodScandel()
        {
            double reputationChange = rnd.Next(1, 10) / 10.0;
            int companyNo = rnd.Next(0, companies.Count);
            reputationChange = reputationChange * -1;
            
            Console.WriteLine("Food Scandel!!! The reputation of " + companies[companyNo].GetName() + " has gone down by " + reputationChange.ToString());
        ...
        private void ProcessBrexit()
        {
            ...
            amountOfChange = 0.2 * companies[companyNo].GetDailyCosts();
                
            Console.WriteLine("BREXIT MEANS BREXIT");
                
            companies[companyNo].AlterDailyCosts(amountOfChange);
///
            amountOfChange = 0.2 * companies[companyNo].GetFuelCostPerUnit();

            companies[companyNo].AlterFuelCostPerUnit(amountOfChange);
        ...
        {
            string companyName;
            Console.Write("Enter the number of the company to remove: ");
            companyName = Console.ReadLine();
            Company temp = null;
