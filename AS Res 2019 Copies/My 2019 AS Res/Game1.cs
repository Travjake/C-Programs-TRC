            ...
            if (SinglePlayerDifficulty == 0 || SinglePlayerDifficulty == 1)
            {
                ...
                while (Moved == false)
                {
                    ...
                    if ((Grid.grid[SNumX, SNumY].counter == BL || Grid.grid[SNumX, SNumY].counter == BH) && Grid.grid[SNumX, SNumY].active == true && Jump == 2)
                    {
                        ...
                        {
                            int Options = 0;
                            if (SNumX + 2 <= cols && SNumY - 2 >= 0 && SNumX - 2 >= 0 && SNumY - 2 <= cols)
                            {
                            ...
                            if (Options == 4)
                            {
                                int Choice2 = Convert.ToInt32(RNumX.Next(0, 5));
                                ...
                                if (SNumX + XCord >= 0 && SNumX + XCord <= cols - 1 && SNumY + YCord <= cols - 1 && SNumY + YCord >= 0 && (Grid.grid[SNumX + XCord / 2, SNumY + YCord / 2].counter == WL || Grid.grid[SNumX + XCord / 2, SNumY + YCord / 2].counter == WH) && Grid.grid[SNumX, SNumY].active == false)
                                {
                            ...
                            if (Options < 4 && Options > 0)
                            {
                                ...
                                {
                                    int Choice3 = Convert.ToInt32(RNumX.Next(0, 5));
                    ...
                    if ((Grid.grid[SNumX, SNumY].counter == BL || Grid.grid[SNumX, SNumY].counter == BH) && Grid.grid[SNumX, SNumY].active == true)
                    {
                        ...
                        if (Grid.grid[SNumX, SNumY].counter == BH)
                        {
                            ...
                            if (Options == 4)
                            {
                                ...
                                if (SNumX + XCord >= 0 && SNumX + XCord <= cols - 1 && SNumY + YCord <= cols - 1 && SNumY + YCord >= 0 && Grid.grid[SNumX + XCord, SNumY + YCord].active == false)
                                {
                                    Grid.grid[SNumX + XCord, SNumY + YCord].active = true;
                                    Grid.grid[SNumX + XCord, SNumY + YCord].counter = Grid.grid[SNumX, SNumY].counter;
                                    Grid.grid[SNumX, SNumY].counter = null;
